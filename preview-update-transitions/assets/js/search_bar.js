...
function SearchBar(id, index_path, metadata_path) {
    ...
    this.create_result_html = function(metadata){
        let data = {
            "href": "/web-preview/preview-update-transitions" + metadata.id,
...
window.onload = () => {
    MainSearchBar = new SearchBar("main-search-bar",
        "/web-preview/preview-update-transitions/assets/search/index.json",
        "/web-preview/preview-update-transitions/assets/search/metadata.json")
}