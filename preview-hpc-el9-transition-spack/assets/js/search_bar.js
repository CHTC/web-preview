...
function SearchBar(id, index_path, metadata_path) {
    ...
    this.create_result_html = function(metadata){
        let data = {
            "href": "/web-preview/preview-hpc-el9-transition-spack" + metadata.id,
...
window.onload = () => {
    MainSearchBar = new SearchBar("main-search-bar",
        "/web-preview/preview-hpc-el9-transition-spack/assets/search/index.json",
        "/web-preview/preview-hpc-el9-transition-spack/assets/search/metadata.json")
}