...
function SearchBar(id, index_path, metadata_path) {
    ...
    this.create_result_html = function(metadata){
        let data = {
            "href": "/web-preview/preview-research-facilitator-job" + metadata.id,
...
window.onload = () => {
    MainSearchBar = new SearchBar("main-search-bar",
        "/web-preview/preview-research-facilitator-job/assets/search/index.json",
        "/web-preview/preview-research-facilitator-job/assets/search/metadata.json")
}