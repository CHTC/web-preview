...
function SearchBar(id, index_path, metadata_path) {
    ...
    this.create_result_html = function(metadata){
        let data = {
            "href": "/web-preview/preview-new-gpu-requirements" + metadata.id,
...
window.onload = () => {
    MainSearchBar = new SearchBar("main-search-bar",
        "/web-preview/preview-new-gpu-requirements/assets/search/index.json",
        "/web-preview/preview-new-gpu-requirements/assets/search/metadata.json")
}