...
let getCollegeData = async () => {
    let response = await fetch("/web-preview/preview-556-table-of-contents-for-uw-research-computing-condor_q-is-left-flushed-aligned/assets/data/chtc-data-summary.json")
