...
function SearchBar(id, index_path, metadata_path) {
    ...
    this.create_result_html = function(metadata){
        let data = {
            "href": "/web-preview/preview-556-table-of-contents-for-uw-research-computing-condor_q-is-left-flushed-aligned" + metadata.id,
...
window.onload = () => {
    MainSearchBar = new SearchBar("main-search-bar",
        "/web-preview/preview-556-table-of-contents-for-uw-research-computing-condor_q-is-left-flushed-aligned/assets/search/index.json",
        "/web-preview/preview-556-table-of-contents-for-uw-research-computing-condor_q-is-left-flushed-aligned/assets/search/metadata.json")
}