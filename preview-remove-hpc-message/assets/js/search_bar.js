...
function SearchBar(id, index_path, metadata_path) {
    ...
    this.create_result_html = function(metadata){
        let data = {
            "href": "/web-preview/preview-remove-hpc-message" + metadata.id,
...
window.onload = () => {
    MainSearchBar = new SearchBar("main-search-bar",
        "/web-preview/preview-remove-hpc-message/assets/search/index.json",
        "/web-preview/preview-remove-hpc-message/assets/search/metadata.json")
}