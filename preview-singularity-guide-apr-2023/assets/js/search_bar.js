...
function SearchBar(id, index_path, metadata_path) {
    ...
    this.create_result_html = function(metadata){
        let data = {
            "href": "/web-preview/preview-singularity-guide-apr-2023" + metadata.id,
...
window.onload = () => {
    MainSearchBar = new SearchBar("main-search-bar",
        "/web-preview/preview-singularity-guide-apr-2023/assets/search/index.json",
        "/web-preview/preview-singularity-guide-apr-2023/assets/search/metadata.json")
}