...
function SearchBar(id, index_path, metadata_path) {
    ...
    this.create_result_html = function(metadata){
        let data = {
            "href": "/web-preview/preview-2022-stats" + metadata.id,
...
window.onload = () => {
    MainSearchBar = new SearchBar("main-search-bar",
        "/web-preview/preview-2022-stats/assets/search/index.json",
        "/web-preview/preview-2022-stats/assets/search/metadata.json")
}