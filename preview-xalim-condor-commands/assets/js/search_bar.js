...
function SearchBar(id, index_path, metadata_path) {
    ...
    this.create_result_html = function(metadata){
        let data = {
            "href": "/web-preview/preview-xalim-condor-commands" + metadata.id,
...
window.onload = () => {
    MainSearchBar = new SearchBar("main-search-bar",
        "/web-preview/preview-xalim-condor-commands/assets/search/index.json",
        "/web-preview/preview-xalim-condor-commands/assets/search/metadata.json")
}