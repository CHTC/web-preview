...
function SearchBar(id, index_path, metadata_path) {
    ...
    this.create_result_html = function(metadata){
        let data = {
            "href": "/web-preview/preview-fall-2023-events" + metadata.id,
...
window.onload = () => {
    MainSearchBar = new SearchBar("main-search-bar",
        "/web-preview/preview-fall-2023-events/assets/search/index.json",
        "/web-preview/preview-fall-2023-events/assets/search/metadata.json")
}