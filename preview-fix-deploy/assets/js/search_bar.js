...
function SearchBar(id, index_path, metadata_path) {
    ...
    this.create_result_html = function(metadata){
        let data = {
            "href": "/web-preview/preview-fix-deploy" + metadata.id,
...
window.onload = () => {
    MainSearchBar = new SearchBar("main-search-bar",
        "/web-preview/preview-fix-deploy/assets/search/index.json",
        "/web-preview/preview-fix-deploy/assets/search/metadata.json")
}