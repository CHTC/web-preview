...
function SearchBar(id, index_path, metadata_path) {
    ...
    this.create_result_html = function(metadata){
        let data = {
            "href": "/web-preview/preview-mar-2024-ap-transition" + metadata.id,
...
window.onload = () => {
    MainSearchBar = new SearchBar("main-search-bar",
        "/web-preview/preview-mar-2024-ap-transition/assets/search/index.json",
        "/web-preview/preview-mar-2024-ap-transition/assets/search/metadata.json")
}