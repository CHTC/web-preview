...
function SearchBar(id, index_path, metadata_path) {
    ...
    this.create_result_html = function(metadata){
        let data = {
            "href": "/web-preview/preview-spring-2025-training" + metadata.id,
...
window.onload = () => {
    MainSearchBar = new SearchBar("main-search-bar",
        "/web-preview/preview-spring-2025-training/assets/search/index.json",
        "/web-preview/preview-spring-2025-training/assets/search/metadata.json")
}