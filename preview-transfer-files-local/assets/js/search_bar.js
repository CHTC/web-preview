...
function SearchBar(id, index_path, metadata_path) {
    ...
    this.create_result_html = function(metadata){
        let data = {
            "href": "/web-preview/preview-transfer-files-local" + metadata.id,
...
window.onload = () => {
    MainSearchBar = new SearchBar("main-search-bar",
        "/web-preview/preview-transfer-files-local/assets/search/index.json",
        "/web-preview/preview-transfer-files-local/assets/search/metadata.json")
}