...
let getCollegeData = async () => {
    let response = await fetch("/web-preview/preview-learning-materials/assets/data/chtc-data-summary.json")
    return await response.json()
}

let getFacilitatorData = async () => {
    let response = await fetch("/web-preview/preview-learning-materials/assets/data/interaction-count.json")
    return await response.json()
}
