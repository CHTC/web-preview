...
function SearchBar(id, index_path, metadata_path) {
    ...
    this.create_result_html = function(metadata){
        let data = {
            "href": "/web-preview/preview-fixing-endyear" + metadata.id,
...
window.onload = () => {
    MainSearchBar = new SearchBar("main-search-bar",
        "/web-preview/preview-fixing-endyear/assets/search/index.json",
        "/web-preview/preview-fixing-endyear/assets/search/metadata.json")
}