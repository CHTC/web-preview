...
let getCollegeData = async () => {
    let response = await fetch("/web-preview/preview-queue-transfer-list/assets/data/chtc-data-summary.json")
    return await response.json()
}

let getFacilitatorData = async () => {
    let response = await fetch("/web-preview/preview-queue-transfer-list/assets/data/interaction-count.json")
    return await response.json()
}
