...
function SearchBar(id, index_path, metadata_path) {
    ...
    this.create_result_html = function(metadata){
        let data = {
            "href": "/web-preview/preview-aowen-hpc-interactive-update3" + metadata.id,
...
window.onload = () => {
    MainSearchBar = new SearchBar("main-search-bar",
        "/web-preview/preview-aowen-hpc-interactive-update3/assets/search/index.json",
        "/web-preview/preview-aowen-hpc-interactive-update3/assets/search/metadata.json")
}