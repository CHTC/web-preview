...
let getCollegeData = async () => {
    let response = await fetch("/web-preview/preview-roadmap/assets/data/chtc-data-summary.json")
    return await response.json()
}

let getFacilitatorData = async () => {
    let response = await fetch("/web-preview/preview-roadmap/assets/data/interaction-count.json")
    return await response.json()
}
