...
function SearchBar(id, index_path, metadata_path) {
    ...
    this.create_result_html = function(metadata){
        let data = {
            "href": "/web-preview/preview-colab-guide" + metadata.id,
...
window.onload = () => {
    MainSearchBar = new SearchBar("main-search-bar",
        "/web-preview/preview-colab-guide/assets/search/index.json",
        "/web-preview/preview-colab-guide/assets/search/metadata.json")
}