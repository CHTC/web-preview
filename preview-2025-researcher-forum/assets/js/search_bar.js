...
function SearchBar(id, index_path, metadata_path) {
    ...
    this.create_result_html = function(metadata){
        let data = {
            "href": "/web-preview/preview-2025-researcher-forum" + metadata.id,
...
window.onload = () => {
    MainSearchBar = new SearchBar("main-search-bar",
        "/web-preview/preview-2025-researcher-forum/assets/search/index.json",
        "/web-preview/preview-2025-researcher-forum/assets/search/metadata.json")
}